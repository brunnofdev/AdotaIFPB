...
const CadastroAnimais = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    abrigoId: '', 
    raca: '',
    nascimentoEstimado: '', // Formato YYYY-MM
    sexoAnimal: '',
    descricao: '',
    peso: '',
    castrado: false,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Falha ao enviar os dados. Verifique a consola para mais detalhes.');
    }
  };
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group-row">
            ...
            <div className="form-group half-width">
              ...
              <select id="sexoAnimal" name="sexoAnimal" value={formData.sexoAnimal} onChange={handleChange} required>
                <option value="">Selecione...</option>
          ...
          <div className="form-group-row">
            <div className="form-group half-width">
              ...
              <input type="text" id="raca" name="raca" value={formData.raca} onChange={handleChange} placeholder="Ex: Labrador" />
            </div>

            <div className="form-group half-width">
              <label htmlFor="peso">Peso (kg)</label>
              <input type="number" step="0.1" id="peso" name="peso" value={formData.peso} onChange={handleChange} placeholder="Ex: 4.5" />
            </div>
          </div>
          ...
          <div className="form-group-row">
             <div className="form-group half-width">
              ...
              <input type="month" id="nascimentoEstimado" name="nascimentoEstimado" value={formData.nascimentoEstimado} onChange={handleChange} placeholder="yyyy-MM" required />
            </div>
          ...
          <div className="form-group checkbox-group">
            <label htmlFor="castrado" className="checkbox-label">
              <input type="checkbox" id="castrado" name="castrado" checked={formData.castrado} onChange={handleChange} />
              O animal é castrado?
            </label>
          </div>
          ...
          <div className="form-group">
            ...
            <input type="url" id="fotoUrl" name="fotoUrl" value={formData.fotoUrl} onChange={handleChange} placeholder="https://exemplo.com/foto.jpg" />
          </div>

          <div className="form-group">
            <label htmlFor="descricao">Descrição *</label>
            <textarea id="descricao" name="descricao" value={formData.descricao} onChange={handleChange} placeholder="Ex: Animal dócil e amigável..." required />
          </div>
